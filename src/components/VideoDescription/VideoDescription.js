...
import viewss from "../../assets/Icons/views.svg";
...
const VideoDescription = ({
  ...
  return (
    ...
    // </section>
    <section className="video">
      <h1 className="video__title">{titles}</h1>
      <div className="video__border"></div>
      <div className="video__container">
        <div className="video__author">
          <p className="video__channel">{channel}</p>
          <p className="video__timestamp">{timestamp}</p>
        </div>
        <div className="video__attraction">
          <div className="video__channel">
            <img src={viewss} alt="views logo" className="video__logoviews" />
